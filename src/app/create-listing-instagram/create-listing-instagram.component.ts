...
@Component({
  selector: 'app-create-listing-instagram',
  templateUrl: './create-listing-instagram.component.html',
  styleUrls: ['./create-listing-instagram.component.scss']
})
export class CreateListingInstagramComponent implements OnInit {
