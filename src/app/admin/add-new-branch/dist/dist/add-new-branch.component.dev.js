...
function () {
  ...
  AddNewBranchComponent.prototype.getbranchdetails = function () {
    ...
    if (this.id) {
      ...
      this.http.get(this.API_URL + "admingetBranchdetails?businessId=" + this.userId + "&branchId=" + this.id, {
        headers: headers
  ...
  AddNewBranchComponent.prototype.submitAddbranch = function () {
    ...
    if (formValue === null || formValue === void 0 ? void 0 : formValue.adminEmail) {
      if (formValue === null || formValue === void 0 ? void 0 : formValue.adminEmail) {// this.myform.get('adminPassword').clearValidators();
    ...
    if (this.id) {
      ...
      if (this.myform.valid) {
        ...
        this.http.post(this.API_URL + "admineditbranch", requestObject, {
          headers: headers
        }).subscribe(function (res) {
          if (res.status == true) {
      ...
      if (this.myform.valid) {
        ...
        this.http.post(this.API_URL + "adminaddbranch", requestObject, {
          headers: headers
        }).subscribe(function (res) {
          if (res.status == true) {
