...
var BusinessEditProfileComponent = /** @class */ (function () {
    function BusinessEditProfileComponent(api, http, route, storage, router, compressImage) {
        this.api = api;
        this.http = http;
        this.route = route;
    ...
    BusinessEditProfileComponent.prototype.formInit = function () {
        this.editProfileForm = new forms_1.FormGroup({
            ...
            phone: new forms_1.FormControl(this.mobileNo, [
                forms_1.Validators.pattern("^([0-9]{0}|[0-9]{8})$"),
            ]),
    ...
    BusinessEditProfileComponent.prototype.submitEditProfileForm = function () {
        ...
        if (this.editProfileForm.valid) {
            this.http.post(this.API_URL + "admineditprofile", formData, { headers: headers }).subscribe(function (res) {
                if (res.status == true) {
