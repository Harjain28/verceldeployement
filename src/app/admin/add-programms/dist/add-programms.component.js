        ...
        this.route.params.subscribe(function (params) {
            ...
            if (_this.id) {
                ...
                _this.http.post(_this.API_URL + "admingetdatabyid", requestData, { headers: headers }).subscribe(function (res) {
                    ...
                    _this.selectedOptions = (_d = _this.editProgramData) === null || _d === void 0 ? void 0 : _d.userId.map(function (item) { return item; }).slice(1);
                });
            }
        });
    }
    ...
    AddProgrammsComponent.prototype.submitaddProgramData = function () {
        ...
        if (this.id) {
            ...
            if (this.addProgram.valid) {
                ...
                this.http.post(this.API_URL + "admineditProgram", requestData, { headers: headers }).subscribe(function (res) {
                    if (res.status == true) {
            ...
            if (this.addProgram.valid) {
                ...
                this.http.post(this.API_URL + "adminaddprograms", requestData, { headers: headers }).subscribe(function (res) {
                    if (res.status == true) {
                        _this.router.navigate(["admin/programms/" + _this.userId + "/" + _this.token]);
                    }
                    else {
