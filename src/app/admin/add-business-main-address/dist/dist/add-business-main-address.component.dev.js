...
var AddBusinessMainAddressComponent =
/** @class */
function () {
  ...
  AddBusinessMainAddressComponent.prototype.ngOnInit = function () {
    ...
    if (((_e = this.fulldata) === null || _e === void 0 ? void 0 : _e.mobileNo.toString().length) > 8) {
      this.mobileNo = (_f = this.fulldata) === null || _f === void 0 ? void 0 : _f.mobileNo.toString().slice(2);
    } else {
      this.mobileNo = ((_g = this.fulldata) === null || _g === void 0 ? void 0 : _g.mobileNo.toString()) === '65' ? '' : (_h = this.fulldata) === null || _h === void 0 ? void 0 : _h.mobileNo.toString();
    }
  ...
  AddBusinessMainAddressComponent.prototype.submitbusinessLocaion = function () {
    ...
    if (this.address1) {
      ...
      if (this.locationform.valid) {
        ...
        this.http.post(this.API_URL + "adminaddmainbranch", requestObject, {
          headers: headers
  ...
  AddBusinessMainAddressComponent = __decorate([core_1.Component({
