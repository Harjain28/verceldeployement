...
var BusinessDetailsComponent = /** @class */ (function () {
    function BusinessDetailsComponent(router, storage, event, api, http, route, fb, compressImage) {
        var _this = this;
        var _a, _b;
        this.router = router;
        ...
        this.route.params.subscribe(function (params) {
            ...
            // this.levelId = '63242085ed6ecd6708d14352';
            ...
            if (_this.adminType === 'superAdmin') {
                ...
                _this.http
                    .get(_this.API_URL + "adminbusinessDetails", { headers: _this.httpOptions.headers, params: params })
                    .subscribe(function (res) {
                    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z;
                    // console.log(res, "adminbusinessDetails");
                    ...
                    _this.selectedOptionsGroups = (_w = _this.classdetails) === null || _w === void 0 ? void 0 : _w.groupId;
                ...
                _this.http.get(_this.API_URL + "admingettag", { headers: _this.httpOptions.headers, params: params }).subscribe(function (res) {
    ...
    BusinessDetailsComponent.prototype.getlevelgroup = function () {
        ...
        this.api.get('getlevelgroup').subscribe(function (res) {
            ...
            // console.log(this.allLevels, 'allLevels');
    ...
    BusinessDetailsComponent.prototype.editbusinessInformation = function () {
        ...
        formData.append("aboutBusiness", formValue === null || formValue === void 0 ? void 0 : formValue.aboutclass);
        // formData.append("mobileNo", formValue?.phonenumber);
        formData.append("webAddress", formValue === null || formValue === void 0 ? void 0 : formValue.Website);
        ...
        if (this.myForm.valid) {
            ...
            this.http.post(this.API_URL + "admineditclass", formData, { headers: headers }).subscribe(function (res) {
                // console.log(res);
                if (res.status == true) {
