...
function () {
  ...
  function GroupDetailsComponent(api, http, router, route, storage, event) {
    ...
    this.route.params.subscribe(function (params) {
      _this.id = params["id"]; //console.log(_this.id, 'idddddddddddd');
  ...
  GroupDetailsComponent.prototype.ngOnInit = function () {
    ...
    this.getGroups(); // this.getAllgroupsData();
  ...
  GroupDetailsComponent.prototype.selectedTabChange = function (event) {
    this.event.groupTag = event.index; // console.log('tab changrd', tabVal.index);
  };
  ...
  GroupDetailsComponent.prototype.onTabClick = function (event) {
    this.filterValue = event.tab.textLabel; //console.log(this.filterValue);
  }; // getdiscussionData() {
  ...
  GroupDetailsComponent.prototype.getAllgroupsData = function () {
    ...
    var userData = JSON.parse(localStorage.getItem('userdata'));
    this.http.get(this.API_URL + "groupDetailsbyId?groupsId=" + this.id).subscribe(function (res) {
      ...
      _this.groupproductData = res.searchData[0].productData; // Faqs Data 
  ...
  GroupDetailsComponent.prototype.onFileChange = function (event) {
    var _this = this; //console.log(event);
    ...
    for (var i = 0; i < event.target.files.length; i++) {
      ...
      reader.onload = function (event) {
        //console.log(event);
        _this.images.push(event.target.result); //console.log(_this.images);
  ...
  GroupDetailsComponent.prototype.groupDiscussionPostForm = function () {
    ...
    if (formValue.title && formValue.title.trim() !== '') {
      ...
      formData.append("description", formValue.description); //console.log(this.groupDiscussionForm);
      ...
      if (this.groupDiscussionForm.valid) {
        ...
        this.http.post(this.API_URL + "creatediscussion", formData, {
          headers: headers
  ...
  GroupDetailsComponent = __decorate([core_1.Component({
