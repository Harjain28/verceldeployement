            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.afAuth.signInWithPopup(provider)];
                    case 1:
                        credential = _a.sent();
                        this.logintype = 'google';
                        return [2 /*return*/, this.updateUserData(credential.user, this.logintype)];
                }
            });
        });
    };
    ...
    AuthService.prototype.appleSignin = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = new firebase["default"].auth.OAuthProvider('apple.com');
                        return [4 /*yield*/, this.afAuth.signInWithPopup(provider)];
                    case 1:
                        credential = _a.sent();
