...
var ChatService = /** @class */ (function () {
    function ChatService(firestore) {
        this.firestore = firestore;
    }
    ChatService.prototype.addNewChat = function (senderId, receiverId) {
        return this.firestore.collection('chat_master').doc('message_list').set(senderId + '-' + receiverId);
    };
    ChatService.prototype.addChat = function (chat, senderId, receiverId) {
