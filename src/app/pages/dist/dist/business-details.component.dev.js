...
function () {
  function BusinessDetailsComponent(router, storage, event, api, http, fb) {
    ...
    this.levelId = JSON.parse(localStorage.getItem('levelname')); // this.diabledFeilds = this.adminType == "subadmin" ? true : false;
    ...
    if (this.adminType == "admin") {
      ...
      this.api.getBusinessBranchDetails().subscribe(function (res) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q; //console.log(res, "getBusinessBranchDetails");
  ...
  BusinessDetailsComponent.prototype.getlevelgroup = function () {
    ...
    this.api.get('getlevelgroup').subscribe(function (res) {
      _this.allLevels = res.levelData; //console.log(_this.allLevels, 'allLevels');
      ...
      _this.allLevels = res.levelData.sort(function (a, b) {
        return a.levelName.toString().toLowerCase().localeCompare(b.levelName.toString().toLowerCase());
      });

      _this.allLevels.forEach(function (element) {
        if (element.levelName.toString() !== 'Not applicable') {
          _this.optionsLevels.push(element); // this.optionsLevels.push({
          //   value: element._id,
  ...
  BusinessDetailsComponent.prototype.selectAll = function () {
    ...
    this.allSelected = false;
    this.selectnew = false; //console.log(this.selectedOptionsLevels, 'this.selectedOptionsLevels');
  };
