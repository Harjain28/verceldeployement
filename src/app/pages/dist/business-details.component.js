...
var BusinessDetailsComponent = /** @class */ (function () {
    function BusinessDetailsComponent(router, storage, event, api, http, fb) {
        ...
        this.levelId = JSON.parse(localStorage.getItem('levelname'));
        ...
        if (this.adminType == "admin") {
            ...
            this.api.getBusineesdetails().subscribe(function (res) {
                ...
                _this.classdetails = res.results[1].classDetails[0];
                _this.allselectedArray = (_a = _this.classdetails) === null || _a === void 0 ? void 0 : _a.level;
                _this.email = (_b = _this.classdetails) === null || _b === void 0 ? void 0 : _b.email;
                _this.classId = (_c = _this.classdetails) === null || _c === void 0 ? void 0 : _c._id;
                _this.headerClass = (_d = _this.classdetails) === null || _d === void 0 ? void 0 : _d.businessName;
                _this["class"] = (_e = _this.classdetails) === null || _e === void 0 ? void 0 : _e.businessName;
                _this.mobileNo = (_f = _this.classdetails) === null || _f === void 0 ? void 0 : _f.mobileNo;
                _this.webaddress = (_g = _this.classdetails) === null || _g === void 0 ? void 0 : _g.webAddress;
                _this.imagesDefault = (_h = _this.classdetails) === null || _h === void 0 ? void 0 : _h.image.slice();
                _this.selectedOptions = (_j = _this.classdetails) === null || _j === void 0 ? void 0 : _j.tags;
                _this.Data.map(function (item, index) {
                    _this.classdetails.sitetype.forEach(function (element) {
                        if (item.value == element) {
                            _this.Data[index].checkedSiteType = true;
                ...
                _this.selectedOptionsCategories = (_k = _this.classdetails) === null || _k === void 0 ? void 0 : _k.businesssubCategory;
                _this.selectedOptionsGroups = (_l = _this.classdetails) === null || _l === void 0 ? void 0 : _l.groupId;
                if (_this.levelId == '63242085ed6ecd6708d14352') {
                    _this.selectedOptionsLevels = [];
                    _this.selectedOptionsLevels = ['63242085ed6ecd6708d14352'];
                }
                else {
                    _this.selectedOptionsLevels = (_m = _this.classdetails) === null || _m === void 0 ? void 0 : _m.level;
                }
                _this.specificFromAge = (_o = _this.classdetails) === null || _o === void 0 ? void 0 : _o.agefrom;
                _this.specificToAge = (_p = _this.classdetails) === null || _p === void 0 ? void 0 : _p.ageto;
                _this.editorData = (_q = _this.classdetails) === null || _q === void 0 ? void 0 : _q.aboutBusiness;
            });
        }
            ...
            this.api.getBusinessBranchDetails().subscribe(function (res) {
                var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
                //console.log(res, "getBusinessBranchDetails");
                _this.classdetails = res.results[1].classDetails[0];
                _this.allselectedArray = (_a = _this.classdetails) === null || _a === void 0 ? void 0 : _a.level;
                _this.email = (_b = _this.classdetails) === null || _b === void 0 ? void 0 : _b.email;
                _this.classId = (_c = _this.classdetails) === null || _c === void 0 ? void 0 : _c._id;
        ...
        if (this.levelId == '63242085ed6ecd6708d14352') {
            this.selectnew = true;
    ...
    BusinessDetailsComponent.prototype.ngOnInit = function () {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_b) {
                ...
                this.formInit();
                this.getInfoText();
                if (this.allselectedArray.length === ((_a = this.classdetails) === null || _a === void 0 ? void 0 : _a.level.length)) {
    ...
    BusinessDetailsComponent.prototype.formInit = function () {
        this.myForm = new forms_1.FormGroup({
            ...
            aboutclass: new forms_1.FormControl(this.editorData, { validators: [forms_1.Validators.required] }),
    ...
    BusinessDetailsComponent.prototype.getSelectedlevelOptions = function (selected) {
        ...
        if (this.selectedlevel.toString() === '63242085ed6ecd6708d14352') {
            localStorage.setItem("levelname", JSON.stringify('63242085ed6ecd6708d14352'));
            this.selectnotApplicable = false;
            this.selectnew = true;
    ...
    BusinessDetailsComponent.prototype.searchbyLevelName = function (value) {
        if (value && value.trim() !== '' && value.length > 0) {
            return this.allLevels.filter(function (level) {
                return level.levelName.toString().toLowerCase().startsWith(value.toLowerCase());
            });
        }
        else {
    ...
    BusinessDetailsComponent.prototype.getlevelgroup = function () {
        ...
        this.api.get('getlevelgroup').subscribe(function (res) {
            ...
            //console.log(_this.allLevels, 'allLevels');
            // for (let i = 0; i < this.allLevels.length; i++) {
            //  if(this.allLevels[i].levelName.toString() === 'Not applicable'){
            //     this.optionsLevels.push({
            //       value: this.allLevels[i]._id,
            //       display: this.allLevels[i].levelName.toString(),
            //     }); 
            //   }
            // }
            _this.allLevels = res.levelData.sort(function (a, b) { return a.levelName.toString().toLowerCase().localeCompare(b.levelName.toString().toLowerCase()); });
    ...
    BusinessDetailsComponent.prototype.deleteEditImage = function (i) {
        //console.log(i);
        this.index = i;
        //console.log(this.imagesDefault.splice(i, 1));
        document.getElementById("upLoader" + i).value = '';
    };
    BusinessDetailsComponent.prototype.editbusinessInformation = function () {
        ...
        if (this.selectedLevel.toString() === '63242085ed6ecd6708d14352' || this.selectedOptionsLevels.toString() === '63242085ed6ecd6708d14352') {
            ...
            formData.append("level", this.selectedlevel ? __spreadArrays(formValue.selectedlevel).join(",") : __spreadArrays(this.selectedlevel).join(","));
        }
        ...
        if (this.myForm.valid) {
            ...
            this.http.post(this.API_URL + "editclass", formData, { headers: headers }).subscribe(function (res) {
                //console.log(res);
                if (res.status == true) {
    ...
    ], BusinessDetailsComponent.prototype, "fruitInput");
    __decorate([
        core_1.ViewChild(mat_select_autocomplete_1.SelectAutocompleteComponent)
    ], BusinessDetailsComponent.prototype, "multiSelect");
    __decorate([
        core_1.ViewChild(mat_select_autocomplete_1.SelectAutocompleteComponent)
    ], BusinessDetailsComponent.prototype, "multiSelectCategories");
    __decorate([
        core_1.ViewChild(mat_select_autocomplete_1.SelectAutocompleteComponent)
    ], BusinessDetailsComponent.prototype, "multiSelectLevels");
    __decorate([
        core_1.ViewChild(mat_select_autocomplete_1.SelectAutocompleteComponent)
    ], BusinessDetailsComponent.prototype, "multiSelectGroup");
