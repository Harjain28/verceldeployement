...
/** @class */
function () {
  function BusinessEditProfileComponent(api, http, storage, router, event) {
    this.api = api;
    this.http = http;
  ...
  BusinessEditProfileComponent.prototype.ngOnInit = function () {
    ...
    this.images = this.fulldata.image; // this.userName = this.fulldata.userName;
  ...
  BusinessEditProfileComponent.prototype.formInit = function () {
    this.editProfileForm = new forms_1.FormGroup({
      ...
      emailOTP: new forms_1.FormControl(this.email, {
        validators: [forms_1.Validators.required, forms_1.Validators.pattern("^([0-9]{4})$")]
      }),
