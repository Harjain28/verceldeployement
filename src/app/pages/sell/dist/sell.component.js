...
var SellComponent = /** @class */ (function () {
    ...
    SellComponent.prototype.SubmitMarketPlaceProducListing = function () {
        ...
        if (this.myForm.valid) {
            ...
            this.http.post(this.API_URL + "createproduct", formData, { headers: headers }).subscribe(function (res) {
                //console.log(res)
                if (res.status == true) {
                    if (_this.userType === 'business') {
    ...
    ], SellComponent.prototype, "multiSelect");
    __decorate([
        core_1.ViewChild(mat_select_autocomplete_1.SelectAutocompleteComponent)
    ], SellComponent.prototype, "multiSelectCategories");
